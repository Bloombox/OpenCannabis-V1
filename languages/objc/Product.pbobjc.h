 ...
 **/
@interface ProductRoot : GPBRootObject
@end

#pragma mark - Product

typedef GPB_ENUM(Product_FieldNumber) {
  Product_FieldNumber_Key = 1,
  Product_FieldNumber_Type = 2,
  Product_FieldNumber_Data_p = 3,
};
...
@property(nonatomic, readwrite, strong, null_resettable) ProductType *type;
