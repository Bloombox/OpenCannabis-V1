...
public struct Address: SwiftProtobuf.Message {
  public static let protoMessageName: String = "Address"
...
extension Address: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public func _protobuf_generated_isEqualTo(other: Address) -> Bool {
