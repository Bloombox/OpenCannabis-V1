...
public struct Brand: SwiftProtobuf.Message {
  public static let protoMessageName: String = "Brand"
  ...
  public var parent: Brand {
    get {return _storage._parent ?? Brand()}
...
extension Brand: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public func _protobuf_generated_isEqualTo(other: Brand) -> Bool {
