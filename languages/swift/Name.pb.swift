...
public struct Name: SwiftProtobuf.Message {
...
extension Name: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "primary"),
    2: .same(proto: "display"),
  ]

  public func _protobuf_generated_isEqualTo(other: Name) -> Bool {
