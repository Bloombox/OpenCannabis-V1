...
public struct Content: SwiftProtobuf.Message {
  public static let protoMessageName: String = "Content"

  public var type: Content.TypeEnum {
    get {return _storage._type}
    set {_uniqueStorage()._type = newValue}
  }

  public var encoding: Content.Encoding {
  ...
  public var compression: Compression {
    get {return _storage._compression ?? Compression()}
...
extension Content: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    var _type: Content.TypeEnum = .text
    var _encoding: Content.Encoding = .utf8
    var _content: Data = SwiftProtobuf.Internal.emptyData
    var _language: Language = .english
    var _compression: Compression? = nil
  ...
  public func _protobuf_generated_isEqualTo(other: Content) -> Bool {
...
extension Content.TypeEnum: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "TEXT"),
...
extension Content.Encoding: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "UTF8"),
  ]
}
