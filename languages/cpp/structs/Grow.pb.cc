...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "structs/Grow.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
void AddDescriptorsImpl() {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "structs/Grow.proto", &protobuf_RegisterTypes);
...
const ::google::protobuf::EnumDescriptor* Grow_descriptor() {
  protobuf_structs_2fGrow_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_structs_2fGrow_2eproto::file_level_enum_descriptors[0];
}
