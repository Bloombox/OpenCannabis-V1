...
class PricingTierAvailability : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:PricingTierAvailability) */ {
 public:
  ...
  #if LANG_CXX11
  PricingTierAvailability(PricingTierAvailability&& from) noexcept
    : PricingTierAvailability() {
    *this = ::std::move(from);
  }

  inline PricingTierAvailability& operator=(PricingTierAvailability&& from) noexcept {
  ...
  friend void swap(PricingTierAvailability& a, PricingTierAvailability& b) {
    a.Swap(&b);
  }
...
class UnitPricingDescriptor : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:UnitPricingDescriptor) */ {
 public:
  ...
  #if LANG_CXX11
  UnitPricingDescriptor(UnitPricingDescriptor&& from) noexcept
    : UnitPricingDescriptor() {
    *this = ::std::move(from);
  }

  inline UnitPricingDescriptor& operator=(UnitPricingDescriptor&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  friend void swap(UnitPricingDescriptor& a, UnitPricingDescriptor& b) {
    a.Swap(&b);
  }
...
class WeightedPricingDescriptor : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:WeightedPricingDescriptor) */ {
 public:
  ...
  #if LANG_CXX11
  WeightedPricingDescriptor(WeightedPricingDescriptor&& from) noexcept
    : WeightedPricingDescriptor() {
    *this = ::std::move(from);
  }

  inline WeightedPricingDescriptor& operator=(WeightedPricingDescriptor&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  friend void swap(WeightedPricingDescriptor& a, WeightedPricingDescriptor& b) {
    a.Swap(&b);
  }
...
class FreebiePricingDescriptor : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:FreebiePricingDescriptor) */ {
 public:
  ...
  #if LANG_CXX11
  FreebiePricingDescriptor(FreebiePricingDescriptor&& from) noexcept
    : FreebiePricingDescriptor() {
    *this = ::std::move(from);
  }

  inline FreebiePricingDescriptor& operator=(FreebiePricingDescriptor&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  friend void swap(FreebiePricingDescriptor& a, FreebiePricingDescriptor& b) {
    a.Swap(&b);
  }
...
class PricingDescriptor : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:PricingDescriptor) */ {
 public:
  ...
  #if LANG_CXX11
  PricingDescriptor(PricingDescriptor&& from) noexcept
    : PricingDescriptor() {
    *this = ::std::move(from);
  }

  inline PricingDescriptor& operator=(PricingDescriptor&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  friend void swap(PricingDescriptor& a, PricingDescriptor& b) {
    a.Swap(&b);
  }
...
class ProductPricing : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ProductPricing) */ {
 public:
  ...
  #if LANG_CXX11
  ProductPricing(ProductPricing&& from) noexcept
    : ProductPricing() {
    *this = ::std::move(from);
  }

  inline ProductPricing& operator=(ProductPricing&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  friend void swap(ProductPricing& a, ProductPricing& b) {
    a.Swap(&b);
  }
