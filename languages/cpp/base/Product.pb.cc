...
namespace protobuf_base_2fProduct_2eproto {
...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "base/Product.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
void AddDescriptorsImpl() {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "base/Product.proto", &protobuf_RegisterTypes);
...
Product::Product()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_base_2fProduct_2eproto::InitDefaults();
  }
  SharedCtor();
...
const ::google::protobuf::Descriptor* Product::descriptor() {
  protobuf_base_2fProduct_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_base_2fProduct_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}
...
::google::protobuf::Metadata Product::GetMetadata() const {
  protobuf_base_2fProduct_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_base_2fProduct_2eproto::file_level_metadata[kIndexInFileMessages];
}
