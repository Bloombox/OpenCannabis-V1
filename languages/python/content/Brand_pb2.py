...
_BRAND = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='Brand.name', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='parent', full_name='Brand.parent', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='summary', full_name='Brand.summary', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='media', full_name='Brand.media', index=3,
