...
_PRICINGTIERAVAILABILITY = _descriptor.Descriptor(
  ...
  full_name='PricingTierAvailability',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='offered', full_name='PricingTierAvailability.offered', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='available', full_name='PricingTierAvailability.available', index=1,
...
_UNITPRICINGDESCRIPTOR = _descriptor.Descriptor(
  ...
  full_name='UnitPricingDescriptor',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='price_value', full_name='UnitPricingDescriptor.price_value', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='status', full_name='UnitPricingDescriptor.status', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='discounts', full_name='UnitPricingDescriptor.discounts', index=2,
...
_WEIGHTEDPRICINGDESCRIPTOR = _descriptor.Descriptor(
  ...
  full_name='WeightedPricingDescriptor',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='weight', full_name='WeightedPricingDescriptor.weight', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='tier', full_name='WeightedPricingDescriptor.tier', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='weightInGrams', full_name='WeightedPricingDescriptor.weightInGrams', index=2,
...
_FREEBIEPRICINGDESCRIPTOR = _descriptor.Descriptor(
  ...
  full_name='FreebiePricingDescriptor',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_PRICINGDESCRIPTOR = _descriptor.Descriptor(
  ...
  full_name='PricingDescriptor',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='type', full_name='PricingDescriptor.type', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='unit', full_name='PricingDescriptor.unit', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='weighted', full_name='PricingDescriptor.weighted', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='freebie', full_name='PricingDescriptor.freebie', index=3,
...
_PRODUCTPRICING = _descriptor.Descriptor(
  name='ProductPricing',
  full_name='ProductPricing',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='discounts', full_name='ProductPricing.discounts', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='manifest', full_name='ProductPricing.manifest', index=1,
...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('\n!io.bloombox.schema.product.structB\022ProductPricingSpecP\001'))
