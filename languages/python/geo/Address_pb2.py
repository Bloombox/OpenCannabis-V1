...
_ADDRESS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='first_line', full_name='Address.first_line', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='second_line', full_name='Address.second_line', index=1,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='state', full_name='Address.state', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='zipcode', full_name='Address.zipcode', index=4,
