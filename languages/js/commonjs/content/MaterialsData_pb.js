...
var structs_Grow_pb = require('../structs/Grow_pb.js');
var structs_Species_pb = require('../structs/Species_pb.js');
var structs_Genetics_pb = require('../structs/Genetics_pb.js');
...
proto.MaterialsData.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    genetics: (f = msg.getGenetics()) && structs_Genetics_pb.Genetics.toObject(includeInstance, f)
  };
...
proto.MaterialsData.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 3:
      ...
      break;
    case 4:
      var value = new structs_Genetics_pb.Genetics;
      reader.readMessage(value,structs_Genetics_pb.Genetics.deserializeBinaryFromReader);
...
proto.MaterialsData.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      4,
      f,
      structs_Genetics_pb.Genetics.serializeBinaryToWriter
    );
  }
};
...
proto.MaterialsData.prototype.getGenetics = function() {
  return /** @type{?proto.Genetics} */ (
    jspb.Message.getWrapperField(this, structs_Genetics_pb.Genetics, 4));
};
