...
var base_Language_pb = require('../base/Language_pb.js');
var base_Compression_pb = require('../base/Compression_pb.js');
...
proto.Content.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    compression: (f = msg.getCompression()) && base_Compression_pb.Compression.toObject(includeInstance, f)
  };
...
proto.Content.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 4:
      ...
      break;
    case 5:
      var value = new base_Compression_pb.Compression;
      reader.readMessage(value,base_Compression_pb.Compression.deserializeBinaryFromReader);
...
proto.Content.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      5,
      f,
      base_Compression_pb.Compression.serializeBinaryToWriter
    );
  }
};
...
proto.Content.prototype.getCompression = function() {
  return /** @type{?proto.Compression} */ (
    jspb.Message.getWrapperField(this, base_Compression_pb.Compression, 5));
};
