...
goog.exportSymbol('proto.Genetics', null, global);
...
proto.Genetics.toObject = function(includeInstance, msg) {
  var f, obj = {
    male: (f = msg.getMale()) && content_Name_pb.Name.toObject(includeInstance, f),
    female: (f = msg.getFemale()) && content_Name_pb.Name.toObject(includeInstance, f)
  };
...
proto.Genetics.prototype.getFemale = function() {
  return /** @type{?proto.Name} */ (
    jspb.Message.getWrapperField(this, content_Name_pb.Name, 2));
};
