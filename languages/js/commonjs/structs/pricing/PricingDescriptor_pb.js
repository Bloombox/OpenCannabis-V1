...
var structs_pricing_SaleDescriptor_pb = require('../../structs/pricing/SaleDescriptor_pb.js');
...
proto.UnitPricingDescriptor.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    structs_pricing_SaleDescriptor_pb.SaleDescriptor.toObject, includeInstance)
  };
...
proto.UnitPricingDescriptor.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 3:
      var value = new structs_pricing_SaleDescriptor_pb.SaleDescriptor;
      reader.readMessage(value,structs_pricing_SaleDescriptor_pb.SaleDescriptor.deserializeBinaryFromReader);
...
proto.UnitPricingDescriptor.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      3,
      f,
      structs_pricing_SaleDescriptor_pb.SaleDescriptor.serializeBinaryToWriter
    );
  }
};
...
proto.UnitPricingDescriptor.prototype.getDiscountsList = function() {
  return /** @type{!Array.<!proto.SaleDescriptor>} */ (
    jspb.Message.getRepeatedWrapperField(this, structs_pricing_SaleDescriptor_pb.SaleDescriptor, 3));
};
...
proto.ProductPricing.prototype.getDiscountsList = function() {
  return /** @type{!Array.<!proto.SaleDescriptor>} */ (
    jspb.Message.getRepeatedWrapperField(this, structs_pricing_SaleDescriptor_pb.SaleDescriptor, 1));
};
